...
if(add_int_abs):
	ui.set_source(1,ui.xstbabs.abs_gal *  ui.xszphabs.abs_intr  * ui.xsconstant.chandra_const * (ui.powlaw1d.p1  + ui.xsbbody.bb))
...
if(add_int_abs):
	ui.set_source(3,ui.xstbabs.abs_gal1 *  ui.xszphabs.abs_intr1  * ui.xsconstant.xrt_const * (ui.powlaw1d.p12 + ui.xsbbody.bb1))
	ui.set_source(4,ui.xstbabs.abs_gal1 *  ui.xszphabs.abs_intr1 * ui.xsconstant.bat2_const * (ui.powlaw1d.p12 + ui.xsbbody.bb1))
else:
	ui.set_source(3,ui.xstbabs.abs_gal1  * ui.xsconstant.xrt_const * (ui.powlaw1d.p12 + ui.xsbbody.bb1))
	ui.set_source(4,ui.xstbabs.abs_gal1  * ui.xsconstant.bat2_const * (ui.powlaw1d.p12 + ui.xsbbody.bb1))
