...
ui.set_source(1,ui.xstbabs.abs_gal  * ui.xsconstant.chandra_const *  ui.xszphabs.abs_intr * (ui.xspexrav.pexrav + ui.xsbbody.bb))
...
sample_flux(abs_gal * chandra_const * abs_intr * (pexrav + bb),0.3,7,num=3)
