...
if(use_pexmon_no_cabs):
	...
	set_par(pexmon.rel_refl, val = 1, min = 0, max = 1, frozen=False)
...
if(use_pexrav_with_line):
	...
	set_par(pexrav.rel_refl, val = 0.308955, min = 0, max = 1, frozen=False)
...
if((use_pexrav) or (use_pexrav_no_cabs)):
	set_par(pexrav.PhoIndex, val = 1.63, min = 0, max = 3, frozen=True)
	set_par(pexrav.foldE, val = 70, min = 0, max = 500, frozen=False)
	set_par(pexrav.rel_refl, val = 0.6, min = 0, max = 1, frozen=False)
	set_par(pexrav.norm, val = 0.00021, min = 0, max = 0.1, frozen=False)
	set_par(bb.kT, val = 0.09, min = 0, max = 2, frozen=True)
