...
ui.set_source(1,ui.xstbabs.abs_gal  * ui.xsconstant.chandra_const * (ui.xspexrav.pexrav + ui.xsbbody.bb +  ui.xszgauss.line))
ui.set_source(2,ui.xstbabs.abs_gal  * ui.xsconstant.bat_const * (ui.xspexrav.pexrav + ui.xsbbody.bb +  ui.xszgauss.line))

print ("Equi Width")
print(eqwidth(abs_gal  * bat_const * (pexrav + bb),abs_gal  * bat_const * (pexrav + bb + line),lo=6.2,hi=6.6,id=1))
