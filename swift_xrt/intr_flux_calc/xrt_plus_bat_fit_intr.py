...
ui.set_par(pexrav.PhoIndex, val = 1.47092, min = 1.47091 , max =  1.47093, frozen=False)
ui.set_par(pexrav.foldE, val =  28.4186,  frozen=True)
ui.set_par(pexrav.rel_refl, val = 4.34906e-05, frozen=True)
ui.set_par(pexrav.norm, val =  0.000668695, frozen=True)
ui.set_par(bb.norm, val =  8.05427e-06, frozen=True)
ui.set_par(bb.kT, val = 0.0767841,  frozen=True)
ui.set_par(xrt_const.factor, val = 1,frozen=True)
ui.set_par(bat_const.factor, val = 1.1, frozen=True)
